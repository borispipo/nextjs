...
# Redaction d'une API avec le boilerplate @next

Pour générer l'api d'une application nextJS, vous devez :  

1. Dans le fichier package.json situé à la racine de votre projet, ajouter la propriété "apidoc" de type object, ayant les informations tels que définis selon le lien https://apidocjs.com/. ces informations sont de la sorte : 
{
  "name": "example",
  "version": "0.1.0",
